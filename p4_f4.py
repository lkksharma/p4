#!/usr/bin/env python3
"""
p4_f4.py -- the NECESSITY GAP: the gate on rung (iv) of the Necessity Ladder (residual RL).
...
Example (wiki, the real gate):
    python p4_f4.py --trace data/wiki_2019t.oracleGeneral --pred markov2 --tau 0.05 --k 1 --mode est
"""
