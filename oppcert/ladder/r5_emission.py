#!/usr/bin/env python3
"""oppcert/ladder/r5_emission.py -- Necessity Ladder rung (ii), the POSITIVE policy: the wide-emission bandwidth

PAPER: Stage 2 rung r5, emission-time fetch (internal name: Policy 1). Wide emission fetched at
prediction time, granted a perfect forecaster: +0.62 / -3.07, at most 6% of the corridor.
...
bootstrap CI excluding zero, on every trace whose F5 cleared.
    ...
    python -m oppcert.ladder.r5_emission --trace data/cluster50.sample10.oracleGeneral --pred markov3 --tau 0.06 \
        --k 1 --wide-k 16 --forecasters markov,blend,oracle
    python -m oppcert.ladder.r5_emission --selftest
"""
...
def selftest():
    ...
    print("  [oppcert.ladder.r5_emission selftest] completed without error\n")
