#!/usr/bin/env python3
"""
oppcert/sim/bootstrap.py -- paired block-bootstrap 95% CI for the LEARNABLE corridor

PAPER: paired block-bootstrap 95% intervals -- every bracketed interval quoted in the paper.
...
Example (wiki, bar config from the strong-bar log):
    python -m oppcert.sim.bootstrap --trace data/wiki_2019t.oracleGeneral --pred markov2 --tau 0.06 --k 1
"""
