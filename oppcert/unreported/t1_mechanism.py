#!/usr/bin/env python3
"""
oppcert/unreported/t1_mechanism.py -- the T1 skeleton (guide W2) + the mechanism test, with ZERO RL.

PAPER: NOT REPORTED. Early mechanism probe that predates the Instrument. See
...
Usage:
    python -m oppcert.unreported.t1_mechanism --trace data/msr_proj_0.oracleGeneral --limit 2000000
...
from oppcert.sim.prefetch import (Markov1, NoPrefetch, PFCache, Prescient, build_obj_positions,
