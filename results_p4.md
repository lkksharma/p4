...
## BOOTSTRAP CI — v3 learnable corridor, all 3 live traces (2026-07-19, `p4_bootstrap.py`)
...
| 2026-07-19 | Bootstrap CI ×3 live traces → **all lower bounds ≥ 8** | `p4_bootstrap.py` (wiki/cluster50/cluster53) |
