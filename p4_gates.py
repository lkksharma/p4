#!/usr/bin/env python3
"""
p4_gates.py -- the W1/W2 kill-tests. Nothing gets built on top of the env until these pass.
...
Usage:
  python p4_gates.py --synth                      # everything, on a synthetic trace (no download)
  python p4_gates.py --trace data/wiki.oracleGeneral --limit 5000000
"""
...
from p4_cache import (Cache, load_oracle_general, synth_trace, verify_trace_format,
