#!/usr/bin/env python3
"""
p4_r9.py -- THE BREAK-EVEN PRECISION FRONTIER: what precision must a causal scheduler reach?
...
across r8) becomes a measured quantity rather than a narrative.
    ...
    python p4_r9.py --trace data/wiki_2019t.oracleGeneral --pred markov2 --tau 0.05 --k 1
"""
